  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        AmenityWrapView(
          amenities: [
            AmenityDisplay(icon: SolarIcons.car, qty: 1, label: "Garaged"),
            AmenityDisplay(icon: SolarIcons.garage, qty: 2, label: "Covered"),
            AmenityDisplay(icon: SolarIcons.bus, qty: 2, label: "Other"),
          ],
        ),
      ],
    );
